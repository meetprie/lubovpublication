...
<body>
 <div id="wrapper">
		...
		<div id="content" class="content">
			<section class="life-mg-banner"></section>
			<section class="life-big-head wow fadeInUp">
				<h1>life story magazine</h1>
				<div class="container-fuild">
					<div class="info">
						<p>Life magazines are customized magazines covering memories, special occasions, relationships and much more, depending on the category chosen. We have a wide range of categories in our magazines, right from birthday to pet. Don't believe it? Check it out for yourself!</p>
					</div>
				</div>
			</section>
			<section class="life-mgs-sec wow fadeInUp">
				<div class="sec-heading text-center">
					<h2>We <span>serve</span> box of joy</h2>
				</div>
				<div class="tab-scroll-list-head" id="Allgm">
					<h3>Types of <span>magazine</span></h3>
				</div>
				<div class="tab-scroll-list">
					<ul>
						...
						<li>
							<a href="#Birthdaymg">Birthday</a>
						</li>
						<li>
							<a href="#Anniversarymg">Anniversary</a>
						</li>
						<li>
							<a href="#Babymg">Baby</a>
						</li>
						<li>
							<a href="#Weddingmg">Wedding</a>
						</li>
						<li>
							<a href="#Engagementmg">Engagement</a>
						</li>
						<li>
							<a href="#Friendshipmg">Friendship</a>
						</li>
						<li>
							<a href="#Travelmg">Travel</a>
						</li>
						<li>
							<a href="#Parantsmg">Parants</a>
						</li>
						<li>
							<a href="#Personalmg">Personal</a>
						</li>
						<li>
							<a href="#Preweddingmg">Prewedding</a>
						</li>
						<li>
							<a href="#Valentinemg">Valentine</a>
						</li>
					</ul>
				</div>
				<div class="lifemgs-list">
					<div class="life-mgs-block wow fadeInUp" id="Birthdaymg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>birthday magazine</h2>
								<p> A custom made magazine design that would make for an  exceptional birthday gift!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
										<a href="pdfpage.php">
									...
									<li>
										<a href="pdfpage.php">
											<img src="images/life4.jpg">
										</a>
									</li>
									<li>
										<a href="pdfpage.php">
											<img src="images/life5.jpg">
										</a>
									</li>
									<li>
										<a href="pdfpage.php">
											<img src="images/life6.jpg">
										</a>
									</li>
								</ul>
							</div>
					...
					<div class="life-mgs-block wow fadeInUp" id="Anniversarymg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>Anniversary magazine</h2>
								<p>Surprise your partner with a gift as graceful as your bond. </p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Babymg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>Baby magazine</h2>
								<p> Cuteness is customizing magazines, no matter the age!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Weddingmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>wedding magazine</h2>
								<p> Tie the knot with customized magazines and a love that will leave you spellbound!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Engagementmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>Engagement magazine</h2>
								<p>All you have to do is get hitched and we will make your memories permanent for you to revisit them any time you want!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Friendshipmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>friendship magazine</h2>
								<p>True friendship is gifting something personalized, something to make them remember you for a lifetime.</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Travelmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>travel magazine</h2>
								<p> Traveling is fun but to capture those moments permanently is ecstatic. Get your memories inked in a personalized magazine so that you can live those moments time and again. </p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Parantsmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>parants magazine</h2>
								<p>They are the reason you can make memories, so how about gifting them their memories for a change? Gift a personalized magazine for the love cherished for a lifetime. </p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Personalmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>personal magazine</h2>
								<p> To love yourself before anyone else is a saying much true so we want you to love yourself a tad bit more with the help of our customized personal magazines!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Preweddingmg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>prewedding magazine</h2>
								<p>A design fondly and ardently customized for the new chapter of your life. </p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
					...
					<div class="life-mgs-block wow fadeInUp" id="Valentinemg">
						<div class="life-mgs-box">
							<div class="life-mgs-info">
								<h2>Valentine/ <br/>Propose Magazine</h2>
								<p>If she says yes, it’s our duty to imprint the moment forever! Don't believe it? Get your hands on one of our valentine/propose magazines and check out the magic for yourself!</p>
							</div>
							<div class="life-mgs-img">
								<ul>
									<li>
