 jQuery(document).ready(function () {
     ...
     jQuery("nav a, .f-menu a").each(function () {
         // and test its normalized href against the url pathname regexp
         if (urlRegExp.test(this.href.replace(/\/$/, ""))) {
             jQuery(this).parent("li").addClass("active");
             jQuery(this).parents("li.dropdown-menu").addClass("active");
         }
     });
     ...
     jQuery(".subm-arrow").click(function () {
         jQuery(this).parents(".dropdown-menu").toggleClass("drop-open");
     });
    ...
    var countries = [
        { id: "KR", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "JP", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "IT", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "FR", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "DE", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "AU", city: "India", latitude: 20.5937, longitude: 78.9629 },
        { id: "GB", city: "India", latitude: 20.5937, longitude: 78.9629 }
    ];
    ...
    function startEverything() {
        headerLabel.hide(0);
        headerLabel.text =
            "[font-size: 12 opacity: 0.5]Lubov Publication";
    ...
    function stage0() {
        if (!piechart) {
            ...
            piechart.data = [
                { answer: "[bold]Lets Start[/b]", value: 400, fontColor: am4core.color("#222a3f") },
                // { answer: "It's impossible!", value: 200, radius: 10 },
                // { answer: "What does bend mean?", value: 40, disabled: true },
                { answer: "Yes, I use amCharts 4", value: 0, disabled: true }
            ];
    ...
    function stage5() {
        ...
        footerLabel.text = "[[Lubov Publication playing]]";
    ...
    function stage7() {
        ...
        if (!pictorialChart) {
            ...
            pictorialChart.data = [
                ...
                {
                    name: "Yes, we are In Lubov Publaction",
                    value: 100,
                    disabled: true
                }
            ];
    ...
    function stage10() {
        ...
        footerLabel.text = "[[One of the best Creator Lubov Publication]]";
        footerLabel.show();
    ...
    function stage135() {
        headerLabel.y = 55;
        headerLabel.text = "Hey, Peoples, Did you see it?";
    ...
    function stage14() {
        ...
        headerLabel.text = "[font-size: 12 opacity: 0.5]Peoples:[/] Visite in my site.";
