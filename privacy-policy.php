...
<body>
 <div id="wrapper">
		...
		<div id="content" class="content">
			...
			<section class="tnc-sec cms-tect">
				<div class="container">
					<div class="sec-heading">
						<h2>Privacy and Policy <br> <span>User Agreement</span></h2>
					</div>
					<div class="normal-cms">
						<p>This Privacy Policy sets out the basis on which information collected from the users or provided by the users is processed by us, Lubov Publication, a company incorporated under the laws of India and having its registered office at 2nd floor, s char rasta, above Radhe Textorium people, Katargam, Surat, Gujarat 395004 IN and/or its subsidiary(ies) and/or affiliate(s) (collectively hereinafter referred to as the “Lubov Publication”), which operates various websites, apps, newsletters and other services including but not limited to delivery of information and content via any mobile or internet connected device or otherwise (collectively the “Service(s)”).</p>
						...
						<h2>1. INFORMATION RECEIVED, COLLECTED AND STORED BY THE COMPANY</h2>
						<p>We collect and process some or all of the following type of information in the course of you using our Services. The type of information we collect will depend on the circumstances and the Service you are using. Generally speaking, the information about the user as collected by the Company is: (a) data supplied by users and (b) data collected from any other source (collectively referred to as “Information”).</p>
						<h3>(a). Information Supplied by Users</h3>

						<h4>(i) Registration Data</h4>
						...
						<p>When you contact using your other accounts like on Facebook, Twitter, Gmail etc. we shall retrieve Information from such account to continue to interact with you and to continue providing the Services.</p>
						<p>The Company may use your Information to provide you with information, special offers, and promotions via various means including e-mail. You may instruct Lubov Publication at any time not to use your personal Information covered by this Privacy Policy to provide you with special offers and promotions.</p>
						...
						<h4>(ii) Subscription or Paid Service Data</h4>
						...
						<h4>(iii) Information about other Individuals</h4>
						...
						<h3>(c) Information collected from any other source</h3>
						...
						<h4>(i) Information from other Sources: Demographic & Purchase Information</h4>
						...
						<h4>(ii)Advertisements& Purchase Information</h4>
						...
						<h2>2. INFORMATION USE BY THE COMPANY</h2>
						<p>We use Information held about you for our legitimate business interests for the following purposes:</p>

						<ul class="icon-list">
							<li>To provide you Services including associated functionalities whether by us or by our designated representatives and/or business partners to you or to parties designated by you and any and all matters ancillary thereto including to carry out obligations from any contracts entered into between us. We rely on performance of our contract with you so as the legal basis for such processing;</li>
							<li>To verify and process payment when you subscribe to, purchase and/or obtain Services from any of our Website. We rely on performance of our contract with you so as the legal basis for such processing;</li>
							<li>For verification and record of your personal particulars, to authenticate you so that we know it is you and not someone else which includes comparing it with Information from other sources and using the Information to communicate with you. We rely on performance of our contract with you so as the legal basis for such processing;</li>
							<li>To conduct market research and statistical analysis of the users of the Website including the number of users, the frequency of use, profile of users and using such analysis for our business plans, the enhancement of our products and services, targeted advertisements and conveying such Information in broad terms (but not information in relation to specific individuals) to third parties who have or propose to have business dealings with us. We rely on legitimate business interests as the legal basis for such processing and the legitimate interest is the analyzing the use of the Services and improving the same;</li>
							<li>To send you Information, promotions and updates including marketing and advertising materials in relation to our Services and those of third party organizations selected by us. We will only do this where we reasonably believe that our Services may be of interest to you and you consent to being provided with such information. We rely on legitimate business interest as the legal basis to promote our Services to you as the legal basis for this processing;</li>
							<li>To prevent fraud or other potentially illegal activities (including copyright infringement) and to block disruptive users and protect the safety of users of our Services. The legal basis for this processing is our legitimate business interests being the proper protection of our business against risks and</li>
							<li>To enforce our terms of Service. The legal basis for this processing being the protection and assertion of our legal rights and the legal rights of others.</li>
							<li>In any case, if you would prefer that we do not use your Information to market or promote our products and Services to you, please either <b>(i)</b> tick the relevant box on the form through which we collect your Information (for example, the registration form); <b>(ii)</b> unsubscribe from our electronic communications using the method indicated in the relevant communication; or <b>(iii)</b> contact us at the contact details set out below:</li>
						</ul>
						<h3>Parimal Kamani, team head.</h3>
						<p>Contact: <a href="tel:7567642020">+91 7567642020</a></p>
						...
						<h2>4. DISCLOSURE OF PERSONAL INFORMATION AND OTHER INFORMATION</h2>

						<h3>(a) Information Shared with Group Companies and Affiliates</h3>
						...
						<h3>(d)Information shared with Other Parties</h3>
						...
						<h3>(e) The Company may present Information to allow social sharing functionality. </h3>
						...
						<h3>(f) Sale or Transfer of all or part of Business of Company</h3>
						...
						<h3>(g) In addition to the scenarios identified above</h3>
						<p>we may share Information about you for any other purposes disclosed to you at the time we collect your Information or pursuant to your consent.</p>

						<h3>(h) Some General Exceptions to Disclosures</h3>
						<p>a) The Website Service may include links to other websites or applications. Such websites or applications are governed by their respective privacy policies, which are beyond our control. Once you leave our servers (you can tell where you are by checking the URL in the location bar on your browser), use of any information you provide is governed by the privacy policy of the operator of the website / app / service you are visiting. That policy may differ from ours. If you can’t find the privacy policy of any of these via a link, you should contact the application / site owners directly for more information.</p>
						...
						<p>b) Any personally identifiable Information provided by you will not be considered as sensitive if it is freely available and / or accessible in the public domain like any comments, messages, blogs, scribbles available on social platforms like Facebook, Twitter etc.</p>
						<p>c) Anything posted / uploaded / conveyed / communicated by users in the websites / apps / services becomes published content and is not considered personally identifiable information subject to this Privacy Policy.</p>
						...
						<h2>6. TRANSFER OF PERSONAL INFORMATION TO OTHER COUNTRIES</h2>
						...
						<h2>7. RIGHTS AVAILABLE TO YOU</h2>
						<p>You have a number of important rights free of charge. In summary, those include rights to:</p>
						<p>a) Access and updating your Information – When you use the Services or the Website, we make good faith efforts to provide you, as and when requested by you, with access to your Information. Further, if there is any change in your Information, you may update it by accessing the relevant page of the Website, or by contacting us. If you have any questions about how we use the Information collected which relates to you, please contact us. We will endeavour to update your Information within 14 working days of any new or updated Information being provided to us, in order to ensure that the Information we hold about you is as accurate and up to date as possible;</p>
						<p>b) Require us to correct any mistakes in your Information – In such case we shall ensure that any Information or data found to be inaccurate or deficient shall be corrected or amended as feasible, subject to any requirement for such Information to be retained by law or for legitimate business purposes;</p>
						<p>c) Require the erasure of your Information in certain situations;</p>
						<p>d) Require us to restrict processing or object at any time to processing of personal Information in certain situations;</p>
						<p>e) Receive the personal Information concerning you which you have provided to us, in a structured, commonly used and machine-readable format and have the right to transmit that data to a third party in certain situations;</p>
						<p>f) Object to decisions being taken by automated means which produce legal effects concerning you or similarly significantly affect you;</p>
						<p>g) Object in certain other situations to our continued processing of your personal Information;</p>
						<p>h) Otherwise restrict our processing of your personal Information in certain circumstances.</p>
						...
						<p><b>email, call or write to us and provide us enough information to identify you [(e.g. account number, user name, registration details)],</b></p>
						<br>
						...
						<h2>9. CHILDREN USING OUR SERVICES</h2>
						...
						<p>Older children <br> Depending on the service, we may also seek to obtain the consent of your parent or guardian if you are under the age of 18.</p>

						<h2>10. MODIFICATIONS TO THIS PRIVACY POLICY</h2>
						...
						<h3>11. QUESTIONS / GRIEVANCE REDRESSAL</h3>
						<p>All questions, comments and requests regarding this Privacy Policy should be addressed to [ADD DETAILS OF YORU LEGAL DEPARTMENT AND LEGAL HEAD]</p>
						<p>Redressal Mechanism: Any complaints. or concerns with regards to the processing of information provided by you or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing by email </p>
						<p>We request you to please provide the following information in your complaint:</p>
						<p>a) Your address, telephone number and e-mail address;</p>
						<p>b) A statement, under penalty of perjury, that the information in the notice is accurate;</p>
						<p>The company shall not be responsible for any communication, if addressed, to any non-designated person in this regard.</p>

						<div class="text-center sec-heading">
							<h2>Cookies Policy</h2>	
						</div>
						<p>Like most websites, the Company’s website (hereinafter “Website”) uses cookies to distinguish you from other users.</p>
						...
						<h2>2. About this Cookie Policy</h2>
						...
						<p>(ii) Flash cookies may be used to store user preferences for media player functionality and without them some video content may not render correctly.</p>
						<p>By using the sites you are agreeing to the use of cookies as described.</p>

						<h2>4. Types of cookie that may be used</h2>
						<p>The following types of cookie are used on this site. We don’t list every single cookie used by name – but for each type of cookie we tell you how you can control its use. <br>A. First Party Cookies <br>These are our own cookies, controlled by us and used to provide information about usage of our site.</p>

						<h3>(i) Personalisation cookies</h3>
						...
						<h3>(iii) Site management cookies</h3>
						...
						<h3>(i) Third-party service cookies</h3>
